...
const templates = {
	...
	item(
		{ allowHTML, classNames: { item, button, highlightedState, itemSelectable, placeholder } }: TemplateOptions,
		{ id, value, label, customProperties, active, disabled, highlighted, placeholder: isPlaceholder }: Item,
	...
	choice(
		{
			allowHTML,
			classNames: { item, itemChoice, itemSelectable, selectedState, itemDisabled, placeholder },
		}: TemplateOptions,
		{
			id,
			value,
	...
	notice(
		{ allowHTML, classNames: { item, itemChoice, noResults, noChoices } }: TemplateOptions,
		innerText: string,
