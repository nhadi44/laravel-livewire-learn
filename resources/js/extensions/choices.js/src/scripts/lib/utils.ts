...
export const isType = (type: string, obj: any): boolean => obj !== undefined && obj !== null && getType(obj) === type;

export const wrap = (element: HTMLElement, wrapper: HTMLElement = document.createElement('div')): HTMLElement => {
...
export const sortByScore = (a: Pick<Choice, 'score'>, b: Pick<Choice, 'score'>): number => {
...
export const existsInArray = (array: any[], value: string, key = 'value'): boolean =>
	array.some((item) => {
		if (typeof value === 'string') {
