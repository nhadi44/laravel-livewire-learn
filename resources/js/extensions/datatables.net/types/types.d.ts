...
export type DomSelector = string | Node | JQuery;

export type InstSelector = DomSelector | InternalSettings;
...
export interface DataTablesStaticUtil {
	 ...
	 */
	get<T = any, D = any>(
		source: string | object | Function | null,
