...
const plugin = ({ addFilter, utils }) => {
	...
	const { Type, isString, replaceInString, guesstimateMimeType, getExtensionFromFilename, getFilenameFromURL } =
		utils;
		...
		(file, { query }) =>
			new Promise((resolve, reject) => {
				...
				const handleRejection = () => {
					...
					const acceptedFileTypesMapped_unique = acceptedFileTypesMapped.filter(function (item, index) {
