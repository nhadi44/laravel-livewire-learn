		...
		m = function (e, t, n) {
			...
			(t = Array.isArray(t) ? t : [t]).forEach(function (t) {
				e.forEach(function (e) {
					...
					'object' == typeof e && ((o = e.key), (i = e.getter || i), (a = e.setter || a)),
						...
						_write: function (e, t, n) {
							...
							return (
								M.forEach(function (i) {
									!1 === i({ props: o, root: k, actions: t, timestamp: e, shouldOptimize: n }) &&
										(r = !1);
								}),
								...
								g.forEach(function (o, i) {
									o.element.parentNode ||
										(k.appendChild(o.element, i), o._read(), o._write(e, R(o, t), n), (r = !1));
								}),
								(m = r),
	...
	var ce,
			...
			return (
				T.serverId
					? ((y = function (e) {
						...
						(S = {
							headers:
								'function' == typeof t.headers ? t.headers(T.serverId) : Object.assign({}, t.headers),
							method: 'HEAD',
						}),
					...
					: (function (i) {
							...
							(c.onload = function (e) {
								...
								(c.onerror = function (e) {
									return a(
										ot('error', e.status, m(e.response) || e.statusText, e.getAllResponseHeaders()),
									);
								}),
								(c.ontimeout = it(a));
						})(function (e) {
							...
							(n.perceivedPerformanceUpdater = (function (e) {
								...
								function (e) {
									(n.perceivedProgress = e),
										...
										i(),
										n.response && 1 === n.perceivedProgress && !n.complete && a();
								},
								r ? It(750, 1500) : 0,
							)),
							(n.request = e(
								...
								function (e) {
									n.perceivedPerformanceUpdater.clear(),
										s.fire('error', H(e) ? e : { type: 'error', code: 0, body: '' + e });
								},
								function (e, t, r) {
				...
				c = function (e, t, n) {
					...
					r.forEach(function (e) {
						...
						JSON.stringify(a[i]) !== JSON.stringify(t) &&
							((a[i] = t), l('metadata-update', { key: o, value: s[o], silent: n }));
				},
				f = Object.assign(
					{
						id: {
						...
						abortProcessing: function () {
							return new Promise(function (e) {
								if (!i.activeProcessor)
									return (i.processingAborted = !0), u(Ie.IDLE), l('process-abort'), void e();
								(a = function () {
									e();
								}),
							...
							return new Promise(function (n, r) {
								...
								null !== o
									? (e(
											...
											function (e) {
												t
													? (u(Ie.PROCESSING_REVERT_ERROR), l('process-revert-error'), r(e))
													: n();
											},
										),
										u(Ie.IDLE),
				...
				DID_UPDATE_ITEM_METADATA: function (r) {
					...
					a.silent ||
						...
						(n.itemUpdateTimeout = setTimeout(function () {
							...
							if (t('IS_ASYNC')) {
								r.origin === ve.LOCAL &&
									e('DID_LOAD_ITEM', { id: r.id, error: null, serverFileReference: r.source });
								var s,
									u = function () {
										setTimeout(function () {
							...
							Oe('SHOULD_PREPARE_OUTPUT', !1, { item: r, query: t, action: i, change: a }).then(
								function (n) {
					...
					if (M(o)) f({ error: ot('error', 0, 'No source'), file: null });
						...
						if (
							...
							if (n.options.allowMultiple || (!n.options.allowMultiple && !n.options.allowReplace)) {
								...
								return (
									e('DID_THROW_MAX_FILES', { source: o, error: E }), void f({ error: E, file: null })
								);
							}
							var _ = Pe(n.items)[0];
						...
						v.on('init', function () {
							...
							v.on('load-file-error', function (t) {
								e('DID_THROW_ITEM_INVALID', { id: h, error: t.status, status: t.status }),
							...
							v.on('process-complete', function (t) {
								e('DID_COMPLETE_ITEM_PROCESSING', { id: h, error: null, serverFileReference: t }),
					...
					if (t('GET_ITEMS_BY_STATUS', Ie.PROCESSING).length !== a) {
						if (r.status !== Ie.PROCESSING) {
							var s = function t() {
								...
								if (r) {
									var o = r.id,
										...
										s = Le(n.items, o);
									s && !s.archived
										? e('PROCESS_ITEM', { query: o, success: i, failure: a }, !0)
										: t();
								}
							};
							r.onOnce('process-complete', function () {
								...
								t('GET_ITEMS_BY_STATUS', Ie.PROCESSING_COMPLETE).length === n.items.length &&
		...
		Bt = S({
			...
			create: function (e) {
				...
				var r = a('svg');
				(t.ref.path = a('path', { 'stroke-width': 2, 'stroke-linecap': 'round' })),
		...
		Ft = S({
			...
			write: function (e) {
				...
				i && !o
					...
					: !i && o && ((n.isDisabled = !1), t.element.removeAttribute('disabled'));
			},
		}),
		qt = function (e) {
			var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : '.',
					...
					var t = e.root,
						...
						r =
							null === n.progress
								...
								: t.query('GET_LABEL_FILE_PROCESSING') + ' ' + jt(n.progress) + '%';
					Nt(t.ref.main, r), Nt(t.ref.sub, t.query('GET_LABEL_TAP_TO_CANCEL'));
				},
			...
			create: function (e) {
				...
				if (
					...
					(_.info.translateX = $t),
						...
						(_.processingCompleteIndicator = { opacity: 1, scaleX: 1, scaleY: 1 });
				}
				...
				var I = r.appendChildView(
					r.createChildView(Bt, { opacity: 0, align: r.query('GET_STYLE_PROGRESS_INDICATOR_POSITION') }),
				);
		...
		vn = A(
			...
			function (e) {
				...
				i &&
					...
					((r.currentState = i.type), (t.element.dataset.filepondItemState = Tn[r.currentState] || ''));
			...
			e.dragOffset
				...
				: ((e.translateX = t),
					...
					Date.now() > e.spawnDate &&
						(0 === e.opacity && yn(e, t, n, r, o), (e.scaleX = 1), (e.scaleY = 1), (e.opacity = 1)));
		},
		...
		Sn = A({
			DID_ADD_ITEM: function (e) {
				...
				(t.ref.lastItemSpanwDate = s),
					t.appendChildView(
						t.createChildView(mn, { spawnDate: s, id: r, opacity: u, interactionMethod: i }),
						o,
					);
			},
					...
					if (1 === m) {
						...
						u.forEach(function (e, t) {
							...
							(R = a),
								(O = s),
								e.markedForRemoval ||
									(o && ((e.translateX = null), (e.translateY = null)), On(e, a, s, u, E));
						});
					}
				}
			},
			...
			DID_DRAG: function (e) {
				...
				t.query('GET_ITEM_INSERT_LOCATION_FREEDOM') &&
					(n.dragCoordinates = {
						...
						top:
							r.position.scopeTop -
							(t.rect.outer.top + t.rect.element.marginTop + t.rect.element.scrollTop),
					});
			},
		...
		bn = S({
			...
			write: function (e) {
				...
				if (
					...
					n.overflowing &&
						!n.overflow &&
						((n.overflowing = !1), (t.element.dataset.state = ''), (t.height = null)),
					n.overflow)
				) {
			...
			var e = function (e) {
				...
				t = {
					destroy: function () {
						...
						(t = e),
							de(Lr, Lr.indexOf(t)),
							0 === Lr.length && (document.removeEventListener('paste', br), (Ar = !1));
					},
					onload: function () {},
				};
			return (
		...
		Gr = function (e, t, n) {
			...
			Nr(
				...
				n +
					...
					r +
					' ' +
					(1 === r ? e.query('GET_LABEL_FILE_COUNT_SINGULAR') : e.query('GET_LABEL_FILE_COUNT_PLURAL')),
			),
				clearTimeout(wr),
			...
			create: function (e) {
				...
				o &&
					...
					(t.ref.label = t.appendChildView(
						t.createChildView(
							Yn,
							Object.assign({}, n, { translateY: null, caption: t.query('GET_LABEL_IDLE') }),
						),
					)),
			...
			write: function (e) {
				...
				if (
					...
					if (((u.translateY = Math.max(0, m - u.rect.element.marginTop) - T.top), c)) {
						...
						R > o.cappedHeight && I.visual > U ? (u.overflow = U) : (u.overflow = null),
					...
					t.ref.credits &&
						l.heightCurrent &&
						(t.ref.credits.style.transform = 'translateY(' + l.heightCurrent + 'px)');
				}
			},
			destroy: function (e) {
				var t = e.root;
		...
		Jr = function () {
			var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
				...
				i = (function (e) {
					...
					{ items: [], listUpdateTimeout: null, itemUpdateTimeout: null, processingQueue: [], options: Q(o) },
					[Ve, $(o)],
					[Pt, K(o)],
				);
							...
							if (i.test(e) && (delete n[e], !1 !== o))
								if (U(o)) n[o] = t;
									...
									var a,
										s = o.group;
									H(o) && !n[s] && (n[s] = {}),
										(n[s][((a = e.replace(i, '')), a.charAt(0).toLowerCase() + a.slice(1))] = t);
								}
						}),
