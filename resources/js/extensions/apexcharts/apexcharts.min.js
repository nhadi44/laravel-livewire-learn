								...
								i = function (i, a, s) {
									...
									if (r) {
										...
										n &&
											...
											i.label.click &&
												n.node.addEventListener('click', i.label.click.bind(t, i)));
									}
								};
						...
						value: function (t) {
							...
							if (a && 'object' === i(a)) {
								...
								(b =
									...
									((null !==
										(u = (a = this.checkForCatToNumericXAxis(this.chartType, b, a)).chart
											.sparkline) &&
										void 0 !== u &&
										u.enabled) ||
						...
						value: function (t) {
							...
							var h = [],
								...
								v = function (t) {
									...
									return (
										Array.isArray(i) && (i = i.join(' ')), x.isNumber(i) ? i : i.split(r).join('')
									);
								},
								m = function (t, e) {
										...
										for (var a = 0; a < t.data.length; a++) {
											...
											if (
												...
												for (var o = 0; o < l.globals.series.length; o++) {
													...
													if (f.isFormatXY())
														h.push(
															null === (n = i[o].data[a]) || void 0 === n ? void 0 : n.y,
														);
													else h.push(g[o][a]);
												}
											}
								...
								var w = function (s) {
										...
										if (d.config.xaxis.labels.show) {
											var k = e.drawText({
												...
												isPlainText: !1,
												cssClass:
													(t ? 'apexcharts-xaxis-label ' : 'apexcharts-xaxis-group-label ') +
													x,
											});
											if (
												(i.add(k),
				...
				r(t, [
					{
						...
						value: function (t, e) {
							...
							return (
								n[n.length - 2] >= e && n.pop(), { result: n, niceMin: n[0], niceMax: n[n.length - 1] }
							);
						},
					},
					{
										...
										(function (t) {
											if (e.dCtx.timescaleLabels && e.dCtx.timescaleLabels.length) {
												var n = e.dCtx.timescaleLabels[0],
													l =
														e.dCtx.timescaleLabels[e.dCtx.timescaleLabels.length - 1]
															.position +
														o / 1.75 -
							...
							for (
								...
								(L.background = s[l]),
									...
									void 0 !== e.globals.seriesColors[l] &&
										((L.background = e.globals.seriesColors[l]),
										...
										var t = i.gridRect.getBoundingClientRect(),
											...
											o = {
												...
												yaxis: {
													...
													max:
														a.globals.yAxisScale[0].niceMax - (e.top - t.top) * s.yRatio[0],
												},
											};
						...
						value: function (t) {
							...
							if (
								...
								s.globals.comboCharts &&
									(n = parseInt(u.parentNode.getAttribute('data:realIndex'), 10));
								var A = function (t) {
						...
						value: function (t) {
							...
							switch (
								(this.barCtx.isReversed &&
									((C = i + h - (S ? 2 * h : 0)), (i = e.globals.gridWidth - h)),
								p.position)
							) {
								case 'center':
					...
					},
					{
						...
						value: function (t) {
							...
							if (c.enabled && !b) {
								...
								var v = '';
								void 0 !== s &&
									(v = f(s, e(e({}, d), {}, { seriesIndex: r, dataPointIndex: o, w: d }))),
								...
								c = function (e, s) {
									...
									h.push(
										(o(
											(r = {}),
											t,
											'x' === t ? n.getXForValue(e, i, !1) : n.getYForValue(e, a, !1),
										),
										o(r, 'attrs', s),
										r),
									);
						...
						value: function (t) {
							...
							if (
								...
								for (var L = 1; L < A; L++) {
									var P, I;
									if (
										(null === (P = this.groupCtx.prevYVal[m - L]) || void 0 === P ? void 0 : P[g]) <
										0
									) {
									...
									if (
										(null === (I = this.groupCtx.prevYVal[m - L]) || void 0 === I
											? void 0
											: I[g]) >= 0
									) {
							...
							for (var d = 0; d < t.length; d++) {
								...
								if (
									...
									if (0 !== u && i.config.plotOptions.pie.dataLabels.minAngleToShowLabel < t[d]) {
										...
										void 0 !== L &&
											(C = L(i.globals.seriesPercent[d][0], { seriesIndex: d, w: i }));
		...
		zt = function (t) {
			for (var e = '', i = 0; i < t.length; i++) {
				...
				s > 4
					...
					: s > 2 &&
						((e += 'S'.concat(a[0], ', ').concat(a[1])), (e += ', '.concat(a[2], ', ').concat(a[3])));
			}
			return e;
		},
		Et = function (t) {
					...
					},
					{
						...
						value: function (t, e) {
							...
							if (s.comboCharts) {
								...
								if (
									(u.series.length > 0 &&
										v.push(p.draw(u.series, 'rangeArea', u.i, u.seriesRangeEnd)),
