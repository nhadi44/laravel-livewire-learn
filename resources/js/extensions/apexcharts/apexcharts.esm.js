				...
				[
					{
						...
						value: function (t, e) {
							...
							var o = t
									...
									.reduce(function (t, e) {
										return (
											parseFloat(e) == e && t.length ? t[t.length - 1].push(e) : t.push([e]), t
										);
									}, []),
								n = [];
							if (o.length > 1) {
					...
					value: function () {
						return (
							...
							e(
								...
								{
									chart: {
										animations: { easing: 'linear', speed: 800, animateGradually: { enabled: !1 } },
									},
									plotOptions: {
										bar: {
											horizontal: !0,
								...
								custom: function (t) {
									return (function (t) {
										var i = M(t),
											...
											n = i.end;
										return X(
											e(e({}, t), {}, { color: a, seriesName: s, ylabel: r, start: o, end: n }),
										);
									})(t);
								},
							},
					...
					value: function (t) {
						...
						if (a && 'object' === i(a)) {
							...
							(b =
								...
								((null !==
									(u = (a = this.checkForCatToNumericXAxis(this.chartType, b, a)).chart.sparkline) &&
									void 0 !== u &&
									u.enabled) ||
					...
					value: function (t) {
						...
						for (var x = 0; x < a.x.length; x++)
							if (((g = a.x[x] + d.offsetX), (u = a.y[x] + d.offsetY + l), !isNaN(g))) {
								...
								'rangeArea' === i &&
									(b = o ? h.globals.seriesRangeStart[s][p] : h.globals.seriesRangeEnd[s][p]);
								var v = '',
									y = function (t) {
						...
						for (
							...
							if (
								(('rangeBar' !== s.chart.type &&
									...
									((r.isRangeData = !0),
									r.isComboCharts
										? ('rangeBar' !== t[d].type && 'rangeArea' !== t[d].type) ||
								...
								'datetime' === s.xaxis.type
									...
									: 'numeric' === s.xaxis.type &&
										((r.isXNumeric = !0),
										n.length > 0 && ((this.twoDSeriesX = n), r.seriesX.push(this.twoDSeriesX))),
									r.labels.push(this.twoDSeriesX);
			...
			r(t, [
				{
					...
					value: function (t, e, i, a) {
						...
						o &&
							...
							void 0 !== d &&
								(h = d(l, t[a], { i: a, dateFormatter: new I(this.ctx).formatDate, w: n })));
						var f, x;
						e.length > 0
							? ((f = e[a].unit),
								(x = null),
								...
								if ((h.length && 0 === e && c.push(h.join(r)), t.data)) {
									...
									for (var a = 0; a < t.data.length; a++) {
										...
										if (
											...
											h.push(
												((d = s),
												'datetime' === l.config.xaxis.type && String(d).length >= 10
									...
									: 'rangeBar' === l.config.chart.type
										...
										: i.map(function (t, e) {
												...
												l.globals.axisCharts &&
													h.push(
														i.split(r).join('') ? i.split(r).join('') : 'series-'.concat(e),
													);
											}),
							l.globals.axisCharts ||
				...
				},
				{
					...
					value: function () {
						...
						for (
							...
							(void 0 !== t.globals.yAxisScale[s] && (a = t.globals.yAxisScale[s].result.length - 1),
							!(a > 2));
							s++
						);
						return (
											...
											o.forEach(function (t, e) {
												if (s[e] <= i.xaxis.max && s[e] >= i.xaxis.min) {
													...
													a.globals.series.forEach(function (i, a) {
														null !== t &&
															((r = Math.min(i[e], r)), (o = Math.max(i[e], o)));
													}),
														o > c && null !== o && (c = o),
														r < h && null !== r && (h = r);
												}
					...
					value: function () {
						...
						if (
							...
							(r = n.xLabelFormat(s, r, l, {
								...
								((e.config.xaxis.convertedCatToNumeric && void 0 === r) || '' === String(r).trim()) &&
									(o = r = '1');
						...
						for (
							...
							(L.background = s[l]),
								...
								e.config.legend.markers.fillColors &&
									...
									(L.background = e.config.legend.markers.fillColors[l]),
								void 0 !== e.globals.seriesColors[l] &&
									((L.background = e.globals.seriesColors[l]), (L.color = e.globals.seriesColors[l])),
								...
								m.setAttrs(f, { rel: l + 1, 'data:collapsed': d || g }),
						...
						if (
							...
							o.tooltipLabels.drawSeriesTexts({
								...
								s.config.tooltip.followCursor
									...
									: s.globals.isBarHorizontal
										? ((l = v) < o.xyRatios.baseLineInvertedY && (l = v - o.tooltipRect.ttWidth),
											(h = S()))
										: ((l = A()), (h = m));
						}
					...
					value: function (t) {
						...
						return (
							a.config.chart.stacked ||
								(p < 0
									? (p = 0 + v)
									: p + g.height / 3 > a.globals.gridHeight && (p = a.globals.gridHeight - v)),
							{
								bcx: h,
								bcy: l,
								dataLabelsX: u,
				...
				},
				{
					...
					value: function (t) {
						...
						var y,
							...
							C = i;
						switch (
							(this.barCtx.isReversed && ((C = i + h - (S ? 2 * h : 0)), (i = e.globals.gridWidth - h)),
							p.position)
						) {
							case 'center':
						...
						if ((l.config.plotOptions.bar.rangeBarGroupRows && (c = 1), this.barCtx.isHorizontal))
							...
							if (
								...
								l.config.xaxis.convertedCatToNumeric && (d = this.barCtx.initialXRatio),
									...
									(r = ((a / c) * parseInt(this.barCtx.barOptions.columnWidth, 10)) / 100) < 1 &&
										(r = 1);
							}
					...
					value: function (t) {
						...
						if (
							...
							this.shouldApplyRadius(l) &&
								(b = g.roundPathCorners(b, d.config.plotOptions.bar.borderRadius)),
							d.config.chart.stacked)
						) {
							var w = this.barCtx;
					...
					value: function (t, i) {
						...
						for (var n = 0, l = 0; n < t.length; n++, l++) {
							...
							for (var I = 0; I < a.globals.dataPoints; I++) {
								...
								this.isHorizontal
									? ((M = this.drawBarPaths(
											e(e({}, X), {}, { barHeight: k, zeroW: g, yDivision: c }),
										)),
				...
				},
				{
					...
					value: function (t) {
						var e = t.realIndex,
							...
							I = new m(this.ctx);
						a ||
							(a = this.barOptions.distributed ? P.globals.stroke.colors[s] : P.globals.stroke.colors[e]),
				...
				},
				{
					...
					value: function (t) {
						...
						if (c.globals.isXNumeric)
							e =
								(n = (c.globals.seriesX[d][g] - c.globals.minX) / this.invertedXRatio - a) +
								a * this.visibleI;
							...
							var o = this.graphics.group({ class: 'apexcharts-bar-series apexcharts-plot-series' }),
								...
								h = function (r, h) {
									...
									var y = a.graphics.group({ class: 'apexcharts-datalabels', 'data:realIndex': v }),
										w = a.graphics.group({ class: 'apexcharts-bar-goals-markers' }),
										k = 0,
										A = 0,
									...
									for (var C = 0; C < s.globals.dataPoints; C++) {
										...
										a.isHorizontal
											? ((I = a.drawStackedBarPaths(
													e(e({}, P), {}, { zeroW: u, barHeight: k, yDivision: d }),
												)),
												(A = a.series[r][C] / a.invertedYRatio))
											: ((I = a.drawStackedColumnPaths(
													e(e({}, P), {}, { xDivision: c, barWidth: A, zeroH: g }),
												)),
						...
						if (
							...
							if (void 0 !== this.groupCtx.prevY[m - 1] && this.groupCtx.prevY[m - 1].length)
								for (var S = 1; S < A; S++) {
									...
									if (
										!isNaN(
											null === (C = this.groupCtx.prevY[m - S]) || void 0 === C ? void 0 : C[g],
										)
									) {
							...
							for (var L = 1; L < A; L++) {
								var P, I;
								if (
									(null === (P = this.groupCtx.prevYVal[m - L]) || void 0 === P ? void 0 : P[g]) < 0
								) {
									w = this.series[d][g] >= 0 ? k - b + 2 * (this.isReversed ? b : 0) : k;
									break;
								}
								if (
									(null === (I = this.groupCtx.prevYVal[m - L]) || void 0 === I ? void 0 : I[g]) >= 0
								) {
					...
					value: function (t, i, a) {
						...
						for (
							var c = o.group({ class: 'apexcharts-'.concat(n, '-series apexcharts-plot-series') }),
								d = function (i) {
									s.isBoxPlot =
										'boxPlot' === r.config.chart.type || 'boxPlot' === r.config.series[i].type;
									var n,
										h,
										d,
										g,
											...
											S = function (a) {
												...
												(c = s.isHorizontal
													? s.drawHorizontalBoxPaths(
															e(e({}, x), {}, { yDivision: h, barHeight: y, zeroW: g }),
														)
													: s.drawVerticalBoxPaths(
															e(e({}, x), {}, { xDivision: n, barWidth: w, zeroH: d }),
														)),
													(p = c.y),
													(u = c.x),
													a > 0 && b.push(u + w / 2),
					...
					value: function (t) {
						...
						for (var f = p ? t.series.length - 1 : 0; p ? f >= 0 : f < t.series.length; p ? f-- : f++) {
							...
							e.globals.dataChanged &&
								((k = this.startAngle),
								(C =
									Math.round((this.totalAngle * x.negToZero(e.globals.previousPaths[f])) / 100) + k)),
						...
						for (
							...
							for (
								var w = s.group({ class: 'apexcharts-datalabels', 'data:realIndex': p }),
									k = s.group({ class: 'apexcharts-rangebar-goals-markers' }),
									A = 0;
								...
								if (this.isHorizontal) {
									...
									a.globals.isXNumeric &&
										(g = (a.globals.seriesX[n][A] - a.globals.minX) / this.xRatio - v / 2),
										(T = g + v * this.visibleI);
									var F = (l - v * z) / 2;
									if (a.config.series[n].data[A].x) {
	...
	zt = function (t) {
		for (var e = '', i = 0; i < t.length; i++) {
			...
			s > 4
				...
				: s > 2 && ((e += 'S'.concat(a[0], ', ').concat(a[1])), (e += ', '.concat(a[2], ', ').concat(a[3])));
		}
		return e;
	},
	Et = function (t) {
					...
					for (var c = [], d = 0; d < t.length; d++) {
						...
						this.ctx.series.addCollapsedClassToSeries(this.elSeries, g),
							r.globals.isXNumeric &&
								...
								(x = (r.globals.seriesX[g][0] - r.globals.minX) / this.xRatio),
							f.push(x);
						var b,
							v = x,
							w = void 0,
						...
						var C = {
							...
							L = this._iterateOverDataPoints(
								e(
									e({}, C),
									{},
									{ iterations: 'rangeArea' === n ? t[d].length - 1 : void 0, isRangeStart: !0 },
								),
							);
						if ('rangeArea' === n) {
							var P = this._calculatePathsFrom({ series: s, i: d, realIndex: g, prevX: k, prevY: S }),
							...
							(L.linePaths[0] = I.linePath + L.linePath),
								(L.pathFromLine = I.pathFromLine + L.pathFromLine);
						}
						this._handlePaths({ type: n, realIndex: g, i: d, paths: L }),
					...
					if (o.config.stroke.show && !this.pointsChart) {
						...
						for (var y = 0; y < r.linePaths.length; y++) {
							...
							var k = e(
								...
								A = n.renderPaths(k);
							if (
								(this.elSeries.add(A), A.attr('fill-rule', 'evenodd'), h.count > 0 && 'rangeArea' !== i)
							) {
				...
				value: function (t) {
					...
					for (var X = n, z = 0; z < a; z++) {
						...
						if (k.globals.isXNumeric) {
							...
							void 0 === k.globals.seriesX[s][z + 1] && (Y = k.globals.seriesX[s][a - 1]),
								(o = (Y - k.globals.minX) / this.xRatio);
						...
						E
							? (n = p - M / S[this.yaxisIndex] + 2 * (this.isReversed ? M / S[this.yaxisIndex] : 0))
							: ((n =
									p -
									i[r][z + 1] / S[this.yaxisIndex] +
									2 * (this.isReversed ? i[r][z + 1] / S[this.yaxisIndex] : 0)),
								'rangeArea' === e &&
									(X =
										p -
										w[r][z + 1] / S[this.yaxisIndex] +
										2 * (this.isReversed ? w[r][z + 1] / S[this.yaxisIndex] : 0))),
							f.push(o),
							b.push(n),
							v.push(X);
						...
						(g = R.areaPaths),
							...
							!this.appendPathFrom ||
								...
								((I += A.line(o, this.zeroY)), (T += A.line(o, this.zeroY))),
							this.handleNullDataPoints(i, F, r, z, s),
				...
				value: function (t) {
					...
					if (
						(Array.isArray(w.config.stroke.curve) &&
							(A = Array.isArray(v) ? w.config.stroke.curve[v[a]] : w.config.stroke.curve[a]),
						(('rangeArea' === e && (w.globals.hasNullValues || w.config.forecastDataPoints.count > 0)) ||
						...
						w.globals.hasNullValues
							? (null !== i[a][r] &&
									(null !== i[a][r + 1]
										? ((p = k.move(g, u) + k.curve(g + C, u, o - C, n, o + 1, n)),
											(f =
												k.move(g + 1, u) +
												k.curve(g + C, u, o - C, n, o + 1, n) +
												k.line(o, S) +
												k.line(g, S) +
												'z'))
										: ((p = k.move(g, u)), (f = k.move(g, u) + 'z'))),
								x.push(p),
								b.push(f))
							: ((p += k.curve(g + C, u, o - C, n, o, n)), (f += k.curve(g + C, u, o - C, n, o, n))),
							(g = o),
							(u = n),
							r === i[a].length - 2 &&
								((f += k.curve(g, u, o, n, o, S) + k.move(o, n) + 'z'),
								'rangeArea' === e && y
									? (p += k.curve(g, u, o, n, o, c) + k.move(o, c) + 'z')
									: w.globals.hasNullValues || (x.push(p), b.push(f)));
						...
						if (null === i[a][r + 1]) {
							p += k.move(o, n);
							var z = w.globals.isXNumeric
								? (w.globals.seriesX[s][r] - w.globals.minX) / this.xRatio
								: o - this.xDivision;
							f = f + k.line(z, S) + k.move(o, n) + 'z';
						}
						null === i[a][r] && ((p += k.move(o, n)), (f += k.move(o, S))),
							'stepline' === A
								? ((p = p + k.line(o, null, 'H') + k.line(null, n, 'V')),
									(f = f + k.line(o, null, 'H') + k.line(null, n, 'V')))
								: 'straight' === A && ((p += k.line(o, n)), (f += k.line(o, n))),
							r === i[a].length - 2 &&
								((f = f + k.line(o, S) + k.move(o, n) + 'z'),
								'rangeArea' === e && y
									? (p = p + k.line(o, c) + k.move(o, c) + 'z')
									: (x.push(p), b.push(f)));
					}
			...
			r(t, [
				{
					...
					value: function (t) {
						...
						return (
							...
							window.TreemapSquared.generate(o, i.globals.gridWidth, i.globals.gridHeight).forEach(
								function (o, n) {
									var l = a.group({
				...
				},
				{
					...
					value: function (t, e, i, a, s, r) {
						var o = new m(this.ctx),
							n =
								o.getTextRects(t, e).width + this.w.config.stroke.width + 5 > s - i && r - a > s - i
									? r - a
									: s - i,
				...
				},
				{
					...
					value: function (t) {
						...
						if (e.minDate > 1) {
							...
							this.timeScaleArray.push({ position: l, value: n, unit: c, year: s, month: x.monthMod(a) });
				...
				},
				{
					...
					value: function (t) {
						var e = t.firstVal,
							...
							h = function (t, e) {
								return (
									t > n.determineDaysOfMonths(e + 1, s) && ((f = 1), (e += 1)), { month: e, date: f }
								);
							},
							c = function (t, e) {
		...
		(a.PathArray = function (t, e) {
				...
				extend: {
					...
					clone: function (t) {
						...
						var e = this.node,
							i = x(e.cloneNode(!0));
						return (
							t ? (t.node || t).appendChild(i.node) : e.parentNode.insertBefore(i.node, e.nextSibling), i
						);
					},
				},
			})),
			...
			(a.Pattern = a.invent({
				...
				extend: {
					...
					attr: function (t, e, i) {
						return (
							'transform' == t && (t = 'patternTransform'), a.Container.prototype.attr.call(this, t, e, i)
						);
					},
				},
				construct: {
				...
				},
				{
					...
					value: function () {
						...
						window.removeEventListener('resize', this.windowResizeHandler),
							...
							(e = jt.get(t)) && (e.disconnect(), jt.delete(t));
